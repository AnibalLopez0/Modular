...
<div class="main-card">
  ...
  <?php else: ?>
    ...
    <div class="top-actions">
      <button  onclick="abrirSelectorPlantilla()" type="button" class="btn-pill"
       data-bs-toggle="modal" data-bs-target="#modalSelector">
        Nueva conducta <i class="bi bi-plus-lg"></i>
      </button>
      <button onclick="irRecordatorios()" class="btn-pill">Ir a recordatorios</button>
      <button class="btn btn-outline-secondary rounded-pill ms-auto" 
      onclick="window.location.href='../Funciones/logout.php'" >Cerrar sesión
      </button>
    </div>
...
<!-- SELECCIONAR CONDUCTAS -->
<div class="modal fade" id="modalSelector" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title">Selecciona una conducta</h5>

                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>

            <div class="modal-body">
                <div id="listaPlantillasSelector"></div>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mb-3">
          <textarea id="reg_descripcion" class="form-control" placeholder="Descripción"></textarea>
        </div>

        <div class="mb-3" id="campoIntensidad">
          <input type="number" id="reg_intensidad" min="1" max="10" required class="form-control" placeholder="Intensidad">
        </div>

        <div class="mb-3" id="campoDuracion">
          <input type="number" id="reg_duracion" min="1" class="form-control" placeholder="Duración en minutos">
        </div>
      </div>
