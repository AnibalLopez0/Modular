function abrirModalNueva() {
    document.getElementById("modalNuevaPlantilla").style.display = "flex";
}

function cerrarModalNueva() {
    document.getElementById("modalNuevaPlantilla").style.display = "none";
}
                ...
                if (Number(p.is_active) === 1) {
                    ...
                    card = `
                        <div class="conducta-row">
                            <button class="icon-btn" title="Editar" onclick="editarPlantilla(${p.id_plantilla})">
